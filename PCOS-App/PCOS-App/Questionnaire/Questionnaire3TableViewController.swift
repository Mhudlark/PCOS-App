...
class Questionnaire3TableViewController: QuestionnaireTableViewController {
    
    
    @IBOutlet weak var depressionSegmentControl: UISegmentedControl!
    
    @IBOutlet weak var pcosDepressionTextView: DesignableTextView!
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        questionsandAnswers.append("\(depressionSegmentControl.selectedSegmentIndex)")
        questionsandAnswers.append("\(pcosDepressionTextView.text ?? "")")
    }
